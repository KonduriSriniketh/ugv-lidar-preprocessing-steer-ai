...
#include "ugv_lidar_preprocessing/dtypes/point_types.hpp"
#include "ugv_lidar_preprocessing/plugins/gravity_align_plugin.hpp"
#include "ugv_lidar_preprocessing/plugins/livox_tag_filter_plugin.hpp"
#include "ugv_lidar_preprocessing/plugins/pointcloud_deskew_plugin.hpp"

namespace ugv_lidar_preprocessing
{
template<>
...
{
    ros_utils::get_optional_param("input_topic", m_input_topic, std::string("points"), nh);
}
...
void LidarPreProcessingNodelet<PointT>::load_plugins(const std::vector<std::string> &plugins_to_init)
{
    ...
    if (!m_plugins_loader)
    {
        m_plugins_loader = std::make_unique<pluginlib::ClassLoader<plugin_interface>>("ugv_lidar_preprocessing",
...
namespace ugv_lidar_pre_processing_nodelet
{
using OusterLidarPreProcessingNodelet =
        ugv_lidar_preprocessing::LidarPreProcessingNodelet<lidar_point_types::OusterPoint>;
using VelodyneLidarPreProcessingNodelet =
        ugv_lidar_preprocessing::LidarPreProcessingNodelet<lidar_point_types::VelodynePoint>;
using LivoxLidarPreProcessingNodelet =
        ugv_lidar_preprocessing::LidarPreProcessingNodelet<lidar_point_types::LivoxPoint>;
}  // namespace ugv_lidar_pre_processing_nodelet

PLUGINLIB_EXPORT_CLASS(ugv_lidar_pre_processing_nodelet::OusterLidarPreProcessingNodelet, nodelet::Nodelet)
PLUGINLIB_EXPORT_CLASS(ugv_lidar_pre_processing_nodelet::VelodyneLidarPreProcessingNodelet, nodelet::Nodelet)
PLUGINLIB_EXPORT_CLASS(ugv_lidar_pre_processing_nodelet::LivoxLidarPreProcessingNodelet, nodelet::Nodelet)
