...
#include "ugv_lidar_preprocessing/PreprocessingParamsConfig.h"
...
private:
     ...
     * @param level Unused.
     */
    void reconfigure_callback(ugv_lidar_preprocessing::PreprocessingParamsConfig &config, uint32_t level);
    ...
    bool is_preprocessor_enabled(const std::string &key,
                                 const ugv_lidar_preprocessing::PreprocessingParamsConfig &config) const;
     ...
     * @param config Current configuration.
     */
    void update_enabled_plugins(const ugv_lidar_preprocessing::PreprocessingParamsConfig &config);
    ...
    std::shared_ptr<dynamic_reconfigure::Server<ugv_lidar_preprocessing::PreprocessingParamsConfig>> m_reconfig_server;
